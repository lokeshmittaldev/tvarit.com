    ...
    <div class="section-padding" id="downClick">
        <div class="container">
            ...
            <div class="row align-items-lg-center">
                <div class="col-lg">
                    <div class="AmimgBox">
                        <img src="./img/ai_software_solution.jpg" alt="AI Software Solution" loading="lazy" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg">
        ...
        <div class="container">
            <div class="white-box-shadow">
                <div class="centerTitle">
                    <div class="sec-mainTitle">TVARIT<sup style="top:-22px;">&reg;</sup> <span class="red">AI</span></div>
    ...
    <div class="section-padding" id="Benefits">
        <div class="container">
            ...
            <div class="row align-items-lg-center">
                <div class="col-lg">
                    <div class="AmimgBox">
                        <img src="img/USE-CASE_Cable.jpg" alt="USE CASE Cable" loading="lazy" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg">
        ...
        <div class="container">
            <div class="row align-items-lg-center">
                ...
                <div class="col-lg order-1 order-lg-2">
                    <div class="AmimgBox">
                        <img src="img/benefits-cable.jpg" alt="Benefits Cable" loading="lazy" class="img-fluid">
                    </div>
                </div>
            </div>
