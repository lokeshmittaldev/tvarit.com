    ...
    <div class="section-padding" id="downClick">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md">
                    <div class="AmimgBox">
                        <img src="./img/predictive_quality.jpg" alt="Predictive Quality" loading="lazy" class="img-fluid">
                    </div>
                </div>
                <div class="col-md">
        ...
        <div class="container">
            <div class="white-box-shadow">
                <div class="centerTitle">
                    <div class="text-big60"><span class="tvarit-black">TVARIT<sup style="top:-22px;">&reg;</sup> AI </span> </div>
                    <h3 class="bold red text-center">SOLUTIONS</h3>
                </div>
                <div class="centerPharseContent text-p">
                We support large and medium-sized manufacturers in optimizing their production processes,
                improving their management systems and achieving higher profitability.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section-padding" id="Benefits">
        <div class="container">
            <div class="row align-items-lg-center">
                <div class="col-lg">
                    <div class="AmimgBox">
                        <img src="img/Use-case_die-casting-Motor_B.jpg" loading="lazy" alt="Use Case Die Casting Motor B" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg order-1 order-lg-2">
                    <div class="AmimgBox">
                        <img src="img/benefits-die-casting-machine.jpg" loading="lazy" alt="Benefits Die Casting Machine" class="img-fluid">
                    </div>
                </div>
            </div>
